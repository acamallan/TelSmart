...
function onAddNewUpdate(){
    ...
    if(GetValue("receive_id") === ""){
        SetValue("receive_id", GetCounter("001","10"));
    }
...
function tab2(){
    ...
    if(GetValueInner("TotalAmount_2") === "0.00"){
        $('#tdentry_2').empty();
        $('#tdentry_2').append('<a oncontextmenu="return false;" href="#" class="action" id="AddEntry" onclick="AddEntryRec_2()" title="Add Entry"><span class="typcn typcn-plus"></span>Add Entry</a>');
...
function tab3(){
    if(GetValueInner("TotalAmount_3") === "0.00"){
        ...
        $('#tdentry_3').empty();
        $('#tdentry_3').append('<a oncontextmenu="return false;" href="#" class="action" id="AddEntry" onclick="AddEntryRec_3()" title="Add Entry"><span class="typcn typcn-plus"></span>Add Entry</a>');
        SetValue("strCounter", 1);
        $('#displayList_3').empty();
        $('#displayList_3').append(
