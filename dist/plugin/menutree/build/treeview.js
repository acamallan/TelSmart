...
YAHOO.extend(YAHOO.widget.TextNode, YAHOO.widget.Node, {
    ...
    getNodeHtml: function() { 
        ...
        sb[sb.length] = '<table border="0" cellpadding="0" cellspacing="0" style="background:#F2F2F2">';
        sb[sb.length] = '<tr>';
       ...
       var path = this.href;
        ...
        sb[sb.length] = '</td>';
        sb[sb.length] = '<td>';
        sb[sb.length] = '<a oncontextmenu="return false;" title="'+page+'"';
        sb[sb.length] = ' id="' + this.labelElId + '", tabindex="-1"';
        ...
        if (this.hasChildren(true)) {
            ...
            sb[sb.length] = ' onclick="window.open(\''+this.href+'\', \'_blank\', \'height=' + screen.height + ',width=' + screen.width + ',scrollbars=yes, titlebar=no\')"';
        }
        sb[sb.length] = ' >';
