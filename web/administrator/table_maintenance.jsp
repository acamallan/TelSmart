...
function Save(){
    ...
    if(mode === "edit"){
        ...
        $.ajax({
            ...
            data: {functionname:encryptJS("UpdateDB"), strSQL:encryptJS(qryUpdate)},
            type: 'GET',
            async: false,
            success: function(response) {
                var result = decryptJS(response.trim());
                if(result === "null"){
        ...
        $.ajax({
            url: baseURL()+'functions/record_functionjs.jsp',
            data: {functionname:encryptJS("InsertDB"), strSQL:encryptJS(qryInsert)},
            type: 'GET',
            async: false,
            success: function(response) {
                var result = decryptJS(response.trim());
...
function Delete(id){
    ...
    $.ajax({
        url: baseURL()+'functions/record_functionjs.jsp',
        data: {functionname:encryptJS("DeleteDB"), strSQL:encryptJS(qryDelete)},
        type: 'GET',
        async: false,
        success: function(response) {
            var result = decryptJS(response.trim());
