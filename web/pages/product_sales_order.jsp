...
table = "was_product_sales_order_header";
fields = "sales_id as rowid, sales_id,customer_id,record_date,userid,status";
mainWhere = "";
where = "sales_id";
...
<div style="margin-left: 100px; top:0px;">
    ...
    <input type="button" name="hd_addCust" id="hd_addCust" value="Add Customer" style="width:100px;" onclick="">
</div>
<fieldset style="width:940px; height: 505px; margin: auto; margin-top: 0px; border: 1px solid #ddd; background-color: #f6f6f6; padding:10px;"  >
    ...
    <div style="position: relative;">
        ...
        <div class="block" style="margin-left: 20px; top: 0px;">
            ...
            <input type="text" name="sales_id" id="sales_id" style="width:80px;">
        </div>
        ...
        <div class="component1" style="width:100%; height:420px; float:left; padding:0px; overflow: auto; margin-top:80px;">
        <table>
            <thead>
                <tr>
...
<%@include file="product_sales_order_jsfunction.jsp"%>
